...
<body>
	...
	<div id="MainArea">
		<!-- 表单内容 -->
		<form action="${path }/servlet/news?method=update" method="post"
			enctype="multipart/form-data">
			<!-- 本段标题（分段标题） -->
			<div class="ItemBlock_Title">
				<img width="4" height="7" border="0"
					src="${path }/sys/style/images/item_point.gif"> 菜品信息&nbsp;
			</div>
			<!-- 本段表单字段 -->
						...
						<table cellpadding="0" cellspacing="0" class="mainForm">
							...
							<tr>
								...
								<td><input type="text" name="course" class="InputStyle"
									value="${news.course }" /> *</td>
							</tr>
							<tr>
								<td>学校</td>
								<td><input type="text" name="school" class="InputStyle"
									value="${news.school }" /> *</td>
							</tr>
							<tr>
								<td>专业</td>
								<td><input type="text" name="profession" class="InputStyle"
									value="${news.profession }" /> *</td>
							</tr>
							<tr>
								<td>学历</td>
								<td><input type="text" name="education" class="InputStyle"
									value="${news.education }" /> *</td>
							</tr>
							<tr>
								<td>自我介绍</td>
								<td><textarea name="introduction" class="TextareaStyle">${news.introduction }</textarea>
								</td>
							</tr>
						</table>
					</div>
