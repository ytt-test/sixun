...
#Menu .level1 .level1Style {
  background: url("${path }/sys/style/images/img/menu_btn_bg.gif") no-repeat scroll 0 0 transparent;
    height: 23px;
    padding-left: 20px;
    padding-top: 5px;
    width: 135px;
...
#Menu .level1 .MenuLevel2 .level2Style{
	...
	padding-top: 5px;
	width: 112px;
	background-image:url(${path }/sys/style/images/img/menu_arrow_single.gif);
	    ...
	    <li class="level1">
            ...
            <ul class="MenuLevel2">
            	<li class="level2 level2Style">
                    <a target="right" href="${path}/servlet/table?method=list">餐桌管理</a>
				</li>
                <li class="level2 level2Style">
                	<a target="right" href="${path}/servlet/type?method=list">注册信息管理</a>
				</li>
                <li class="level2 level2Style">
                	<a target="right" href="${path }/servlet/news?method=list">档案信息管理</a>
				</li>
                <li class="level2 level2Style">
                	<a target="right" href="${path }/servlet/order?method=list">餐厅订单</a>
				</li>
            </ul>
        </li>
    </ul>
